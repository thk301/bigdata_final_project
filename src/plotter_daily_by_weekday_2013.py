############################################
#   Plots daily trend of one year
#   
#   May 7, 2015
#
#   Input is hard-coded: 1 year results from reducer_daily.py
#
#
############################################
...
if __name__ == "__main__":
    ...
    ax1.set_xlabel('2013 Taxi Ride - By Weekday')
    ax1.annotate('Thursday Evening', xy=(24*4.8, 1600000),  xycoords='data',
                xytext=(0.65, 0.8), textcoords='axes fraction',
                arrowprops=dict(facecolor='black', shrink=0.05),
                horizontalalignment='right', verticalalignment='top',
                )
    ax1.annotate('Friday Evening', xy=(24*5.8, 1600000),  xycoords='data',
