...
if __name__ == "__main__":
    ...
    oneQT={}
    for k,v in sorted(newDay.iteritems())[:24*7*3]:
          time = k[8:]
          if time in oneQT:
              oneQT[time]+=int(v)
          else:
    ...
    twoQT={}
    for k,v in sorted(newDay.iteritems())[24*7*3:24*7*6]:
          time = k[8:]
          if time in twoQT:
              twoQT[time]+=int(v)
          else:
    ...
    threeQT={}
    for k,v in sorted(newDay.iteritems())[24*7*6:24*7*9]:
          time = k[8:]
          if time in threeQT:
              threeQT[time]+=int(v)
          else:
    ...
    fourQT={}
    for k,v in sorted(newDay.iteritems())[24*7*9:24*7*12]:
          time = k[8:]
          if time in fourQT:
              fourQT[time]+=int(v)
          else:
    ...
    ax1.set_xlabel('2013 Taxi Ride - by Different QTs')
